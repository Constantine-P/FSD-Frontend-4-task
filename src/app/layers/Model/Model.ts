...
class Model extends EventEmitter {
  ...
  get dataToView(): DataToView {
    return {
      minHandlePosition: this.relRange.min,
      maxHandlePosition: this.relRange.max,
  ...
  private get relRange(): RangeValue {
    return ({
  ...
  private set relRange(value: RangeValue) {
    this.isSlide = false;
